; keyint.inc
; International keyboard handler part 1 of 2

D0DA5:	
		; Keycodes for scancode 000H-02FH Normal layout
		...
		; Keycodes for scancode 000H-02FH Shift layout
		DEFB	")" ,"!" ,"@" ,"#" ,"$" ,"%" ,"^" ,"&"
		DEFB	"*" ,"(" ,"_" ,"+" ,"|" ,"{" ,"}" ,":"
		DEFB	022H,"~" ,"<" ,">" ,"?" ,0FFH,"A" ,"B"
		DEFB	"C" ,"D" ,"E" ,"F" ,"G" ,"H" ,"I" ,"J"
		...
		; Keycodes for scancode 000H-02FH Graph layout
		...
		; Keycodes for scancode 000H-02FH Shift+Graph layout
		...
		; Keycodes for scancode 000H-02FH Code layout
		...
		; Keycodes for scancode 000H-02FH Shift+Code layout
...
; Input:  A = scancode (030H-057H)
; Remark: code identical among keyboard layout versions
C0F10:		SYSHOOK	H_KEYA
		LD	E,A
		LD	D,0
		LD	HL,D1033-030H
		ADD	HL,DE
...
KEYCOD: 	LD	A,C
		LD	HL,I1B96
		SYSHOOK	H_KEYC
		LD	D,C0F06 / 256		; it is assumed that all handlers are in the 0F00H-0FFFH area!
