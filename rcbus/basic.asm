...
I3D75:		DEFB	0
		DEFB	"NEXT without FOR",0			; 01
		DEFB	"Syntax error",0			; 02
		DEFB	"RETURN without GOSUB",0		; 03
		DEFB	"Out of DATA",0				; 04
		DEFB	"Illegal function call",0		; 05
		DEFB	"Overflow",0				; 06
		DEFB	"Out of memory",0			; 07
		DEFB	"Undefined line number",0		; 08
		DEFB	"Subscript out of range",0		; 09
		DEFB	"Redimensioned array",0			; 10
		DEFB	"Division by zero",0			; 11
		DEFB	"Illegal direct",0			; 12
		DEFB	"Type mismatch",0			; 13
		DEFB	"Out of string space",0			; 14
		DEFB	"String too long",0			; 15
		DEFB	"String formula too complex",0		; 16
		DEFB	"Can't CONTINUE",0			; 17
		DEFB	"Undefined user function",0		; 18
		DEFB	"Device I/O error",0			; 19
		DEFB	"Verify error",0			; 20
		DEFB	"No RESUME",0				; 21
		DEFB	"RESUME without error",0		; 22
		DEFB	"Unprintable error",0			; 23
		DEFB	"Missing operand",0			; 24
		DEFB	"Line buffer overflow",0		; 25
		DEFB	"FIELD overflow",0			; 26
		DEFB	"Internal error",0			; 27
		DEFB	"Bad file number",0			; 28
		DEFB	"File not found",0			; 29
		DEFB	"File already open",0			; 30
		DEFB	"Input past end",0			; 31
		DEFB	"Bad file name",0			; 32
		DEFB	"Direct statement in file",0		; 33
		DEFB	"Sequential I/O only",0			; 34
		DEFB	"File not OPEN",0 			; 35
...
J40D3:		XOR	A
		...
		LD	HL,I3D75
HERRP:		SYSHOOK	H_ERRP			; hook error pointer
		LD	A,E
...
HGETP:		SYSHOOK	H_GETP			; hook for disk
...
HNOFO:		SYSHOOK	H_NOFO			; open statement extension hook
...
HNULO:		SYSHOOK	H_NULO			; open for disk hook
...
HNTFL:		SYSHOOK	H_NTFL			; close for disk hook
		JP	DERIER			; internal error (should not return to here)
...
HDGET:		SYSHOOK	H_DGET			; GET/PUT for disk hook
		JP	DERNMF			; bad filename
...
C6C48:		PUSH	HL
		...
		JR	NC,J6C57		; nope,
HFILO:		SYSHOOK	H_FILO			; sequential output for disk hook
		JP	DERNMF			; bad filename
...
HLOC:		SYSHOOK	H_LOC			; LOC for disk
...
C6D14:		SYSHOOK	H_SAVD
		...
		JR	C,J6D30			; not a disk drive device, i/o function dispatcher and quit
HLOF:		SYSHOOK	H_LOF			; LOF for disk
		JR	J6D36			; internal error (should not return to here)
...
HEOF:		SYSHOOK	H_EOF			; EOF for disk
...
HBAKU:		SYSHOOK	H_BAKU			; backup for disk hook
		JP	DERIER			; internal error (should not return to here)
...
HNODE:		SYSHOOK	H_NODE			; hook device name parser: no device specified
		RET
