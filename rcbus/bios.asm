...
TAPION:
TAPIN:		ret
		; re-use space for custom HBIOS routines
...
A1A51:		dec	l
		...
		ld	a,00BH
		out	(0ABH),a		; write high to TAP port
A1A59:		dec	h
		jp	nz,A1A59		; wait high part
		ld	a,00AH
		out	(0ABH),a		; write low to TAP port
		pop	af
		ret
...
TAPION:
A1A63:		ld	a,008H
		out	(0ABH),a		; write casettemotor on to TAP port
		di
		ld	a,00EH
		out	(PSG0),a		; select register 14 of PSG
A1A6C:		ld	hl,1111
A1A6F:		ld	d,c
